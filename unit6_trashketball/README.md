...
Classroom review game for **Pre-Calculus Unit 6 (sections 6.1–6.4)** — Sequences, Series, and the Binomial Theorem.
...
The repo's hub `index.html` (one folder up) links to `unit6_trashketball/dist/index.html`. With `base: './'` in `vite.config.ts`, the built bundle uses relative asset paths, so the same `dist/` works whether it's served from:

- `https://<user>.github.io/precalculus_games/unit6_trashketball/dist/`
...
- `Desktop/Unit 6 - Seq & Series/assessments/Study Guide - Unit 6 Test (6.1-6.4)/Unit6_Test_Study_Guide_6_1_6_4.tex`
- `Desktop/Unit 6 - Seq & Series/assessments/Unit 6 Test - Sequences, Series, and Binomial Theorem/Unit6_Test_Sequences_Series_Binomial_Version_B.tex`
